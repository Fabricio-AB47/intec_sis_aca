...
SISACADEMICO_FLOW_CATALOG: tuple[dict[str, str], ...] = (
    ...
    _flow("gestion-sisacademico", "materias_consecutivas", "Materias consecutivas", "Operación / Catálogos"),
    ...
    _flow("gestion-sisacademico", "paralelos_horarios", "Paralelos de horarios", "Operación / Catálogos"),
    _flow("gestion-sisacademico", "dias_semana", "Días de la semana", "Operación / Catálogos"),
    ...
    _flow("gestion-sisacademico", "horarios_academicos", "Horarios académicos", "Operación / Control académico"),
