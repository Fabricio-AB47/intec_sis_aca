...
SECTIONS: dict[str, dict[str, Any]] = {
    "estudiantes": {
        "title": "Estudiantes",
        "category": "Personas",
        "description": 'Datos académicos, contacto y campos regulatorios principales de DATOS_ESTUD.',
        "table": "[dbo].[DATOS_ESTUD]",
        "key_fields": ["Cedula_Est"],
        "list_fields": fields(
            ("codigo_estud", 'Código', "number"),
            ("Cedula_Est", 'Cédula'),
    ...
    "actualizacion_estudiantes": {
        "title": 'Actualización de estados de estudiantes',
        "category": "Personas",
        "description": 'Actualice el estado académico del estudiante en DATOS_ESTUD usando el catálogo dbo.ESTADO.',
        ...
        "detail_fields": fields(
            ...
            ("ciudad", "Ciudad"),
            ("Nacionalidad", "Nacionalidad"),
            ("total_matriculas", 'Matrículas', "number"),
            ("total_materias", "Materias registradas", "number"),
            ("ultimo_periodo", 'Último período', "number"),
        ),
        "editable_fields": fields(
    ...
    "docentes": {
        "title": "Docentes",
        "category": "Personas",
        "description": 'Ficha editable del docente, contacto, perfil y datos académicos.',
        "table": "[dbo].[DATOSDOCENTE]",
        "key_fields": ["cedula_doc"],
        "list_fields": fields(
            ("codigo_doc", 'Código', "number"),
            ("cedula_doc", 'Cédula'),
        ...
        "create_fields": fields(
            field("codigo_doc", 'Código', "number", required=True),
            field("cedula_doc", 'Cédula', required=True),
    ...
    "actualizacion_est": {
        ...
        "category": "Docencia",
        "description": 'Verifique DATOSDOCENTE y todos los usuarios vinculados para activar o inactivar docentes.',
        ...
        "detail_fields": fields(
            ...
            ("Informacion", "Descripción del usuario", "textarea"),
            ("cedula_doc", "Cédula docente"),
            ("apellidos_nombre", "Docente"),
            ("correo_docente", "Correo docente"),
            ...
            ("num_carnet_cona", "Número de carné"),
    ...
    "preinscripciones": {
        ...
        "detail_fields": fields(
            ...
            ("Prematricula", "Prematrícula", "number"),
            ("urlcedula", 'URL cédula'),
            ("urltitulo", 'URL título'),
            ("urldeposito", 'URL depósito'),
            ...
            ("Num_Representante", 'Cédula representante'),
        ),
        "editable_fields": fields(
            ("Apellidos_nombre", "Aspirante"),
            ("codperiodo", 'Período', "number"),
        ...
        "create_fields": fields(
            field("Codestu", 'Código aspirante', "number", required=True),
            field("Cedula", 'Cédula', required=True),
    ...
    "carreras": {
        "title": "Carreras",
        "category": 'Académico',
        "description": 'Catálogo de carreras o escuelas académicas.',
        "table": "[dbo].[CARRERAS]",
    ...
    "paralelos": {
        "title": "Paralelos",
        "category": 'Académico',
        "description": 'Catálogo base de paralelos utilizados en matrícula y docencia.',
        "table": "[dbo].[PARALELOS]",
        "key_fields": ["paralelo"],
        "list_fields": fields(
            ("num", 'Número', "number"),
    ...
    "materias": {
        ...
        "category": 'Académico',
        "description": 'Malla, materia, semestre, créditos, horas y estado.',
        "table": "[dbo].[PENSUM]",
    ...
    "periodos": {
        ...
        "category": 'Académico',
        "description": 'Configuración de períodos, fechas, visibilidad y control de plataforma.',
        "table": "[dbo].[PERIODO]",
    ...
    "matricula_materias": {
        ...
        "detail_fields": fields(
            ...
            ("codigo_materia", "Materia", "number"),
            ("codigo_periodo", 'Período', "number"),
            ("Num_Matricula", 'Matrícula', "number"),
            ("paralelo", "Paralelo"),
            ...
            ("Recuperacion", 'Recuperación', "decimal"),
            ("caprueba", "Aprueba"),
        ...
        "create_fields": fields(
            ...
            ("NumGrupo", "Grupo", "number"),
            ("Num_Creditos", 'Créditos', "number"),
            ("Fecha_Matricula", 'Fecha matrícula', "date"),
            ("TipoMatricula", "Tipo"),
            ("ControlMatricula", 'Control matrícula', "number"),
            ("NumCertificado", "Certificado", "number"),
            ("gcer", "Genera certificado", "number"),
            ("NumMatricuMod", 'Modificación de matrícula', "number"),
    ...
    "cabecera_matricula": {
        "title": 'Cabecera matrícula y pagos',
        "category": 'Matrícula',
        "description": 'Cabecera económica y documental de matrícula por estudiante, carrera y período.',
        ...
        "detail_fields": fields(
            ...
            ("fecha_pago", "Fecha pago", "date"),
            ("valor", "Valor", "decimal"),
            ("num_dep_transf", 'Depósito'),
            ("InscripValor", 'Inscripción', "decimal"),
            ("MatriValor", 'Matrícula valor', "decimal"),
            ...
            ("coddias", 'Días', "number"),
            ("codjornada", 'Jornada código', "number"),
            ("codestadoMat", 'Estado matrícula', "number"),
            ("urlcedula", 'URL cédula'),
            ("urltitulo", 'URL título'),
            ("urldeposito", 'URL depósito'),
            ("urlconvenio", "URL convenio"),
    ...
    "empresas": {
        ...
        "description": "Empresas para prácticas profesionales.",
        "table": "[dbo].[EMPRESA]",
        "key_fields": ["Num_emp"],
        "list_fields": fields(
            ("Num_emp", 'Código', "number"),
            ("Empresa", "Empresa"),
            ("Direccion", 'Dirección'),
            ("Telefono", 'Teléfono'),
            ("Correo", "Correo"),
    ...
    "practicas": {
        ...
        "category": 'Vinculación',
        "description": "Prácticas por estudiante, empresa, tutor, fechas y horas.",
    ...
    "pagos_matricula": {
        ...
        "category": 'Matrícula',
        "description": 'Registro de pagos, depósitos y valores asociados a matrícula.',
        "table": "[dbo].[REGISTROPAGOS]",
        "key_fields": ["NumReg"],
        "list_fields": fields(
            ("NumReg", "Registro", "number"),
            ("Codestu", 'Código estudiante', "number"),
            ("estudiante_nombre", "Estudiante"),
            ("estudiante_cedula", 'Cédula'),
            ("codperiodo", 'Período', "number"),
            ("cod_anio_Basica", "Carrera", "number"),
        ...
        "detail_fields": fields(
            ...
            ("usuarioreg", "Usuario"),
            ("urldeposito", 'URL depósito'),
            ("NoDeposito", 'No. depósito'),
            ("Banco", "Banco"),
            ("FechaDeposito", 'Fecha depósito', "date"),
        ...
        "create_fields": fields(
            ...
            ("Num", 'Número', "number"),
            field("codperiodo", 'Período', "number", required=True),
            field("cod_anio_Basica", "Carrera", "number", required=True),
            ("fechapago", "Fecha pago", "date"),
            ("Detalle", "Detalle", "textarea"),
            ("Valor", "Valor", "decimal"),
    ...
    "mallas": {
        ...
        "category": 'Académico',
        "description": 'Mallas activas por carrera usadas para materias, niveles y asignación docente.',
    ...
    "cambio_periodo_hr": {
        ...
        "list_fields": fields(
            ("codigo_periodo", 'Período origen', "number"),
            ("TipoMatricula", 'Tipo matrícula'),
        ),
        "detail_fields": fields(
            ("codigo_periodo", 'Período origen', "number"),
    ...
    "jornadas": {
        "title": "Jornadas",
        "category": "Catálogos",
        "description": 'Catálogo de jornadas por modalidad.',
        "table": "[dbo].[JORNADA]",
        "key_fields": ["NumJ"],
        "list_fields": fields(
            ("NumJ", 'Código', "number"),
    ...
    "modalidades": {
        "title": 'Modalidades de matrícula',
        "category": "Catálogos",
        "description": 'Modalidades usadas en admisión y matrícula.',
    ...
    "menu_usuarios": {
        ...
        "create_fields": fields(
            ...
            ("Grupo", "Grupo"),
            field("idOpcion", 'Opción id', "number", required=True),
            ("Opcion", 'Opción'),
            ("url", "URL"),
            ("ReporteCry", "Reporte", "number"),
        ),
    ...
    "seguimiento": {
        ...
        "description": 'Observaciones y seguimiento activo por estudiante, período y materia.',
        "table": "[dbo].[SEGUIMIENTO_ESTUDIANTE]",
        "key_fields": ["id"],
        "list_fields": fields(
            ("id", "Id", "number"),
            ("codigo_estud", 'Código estudiante'),
            ("estudiante_nombre", "Estudiante"),
            ("estudiante_cedula", 'Cédula'),
            ("codigo_periodo", 'Período'),
        ...
        "create_fields": fields(
            ...
            field("codigo_periodo", 'Período', required=True),
            field("codigo_materia", "Materia", required=True),
            ("tipo_seguimiento", "Tipo"),
            field("observacion", 'Observación', "textarea", required=True),
            ("usuario_registro", "Usuario"),
            ("nombres", "Nombres"),
        ),
    ...
    "datos_factura": {
        ...
        "category": "Admisión",
        "description": 'Datos tributarios heredados del flujo de preinscripción y prematrícula.',
        "table": "[dbo].[DATOSFACTURA]",
        "key_fields": ["CODESTUD"],
        "list_fields": fields(
            ("CODESTUD", 'Código estudiante', "number"),
            ("estudiante_nombre", "Estudiante"),
            ("estudiante_cedula", 'Cédula estudiante'),
            ("CEDRUCFACTURA", 'Cédula/RUC'),
        ...
        "create_fields": fields(
            field("CODESTUD", 'Código estudiante', "number", required=True),
            field("CEDESTUD", 'Cédula estudiante', required=True),
            field("CEDRUCFACTURA", 'Cédula/RUC', required=True),
    ...
    "fechas_notas": {
        ...
        "description": 'Rangos de fechas para habilitar ingreso de notas por parcial y período.',
        "table": "[dbo].[ACTIVAREXAMEN]",
        "key_fields": ["NumNota", "periodo_acad"],
        "list_fields": fields(
            ("periodo_acad", 'Período', "number"),
    ...
    "fechas_autoevaluacion": {
        "title": "Apertura de autoevaluación",
        "category": 'Control académico',
        "description": 'Rango vigente para la autoevaluación docente por período académico.',
    ...
    "evaluacion_resultados": {
        ...
        "category": "Docencia",
        "description": 'Respuestas y puntajes de evaluación docente, pares académicos y autoevaluación.',
    ...
    "preguntas_evaluacion": {
        ...
        "category": "Docencia",
        "description": 'Banco de preguntas usado por evaluación docente, pares académicos y autoevaluación.',
        ...
        "list_fields": fields(
            ...
            ("TipoPreg", "Tipo pregunta", "number"),
            ("Comentariocoord", 'Comentario coordinación', "textarea"),
    ...
    "provincias": {
        "title": "Provincias",
        "category": "Catálogos",
        "description": 'Catálogo territorial utilizado en inscripción y datos del estudiante.',
    ...
    "dias_matricula": {
        "title": 'Días de matrícula',
        "category": "Catálogos",
        "description": 'Catálogo legacy de días usados por el proceso de matrícula.',
    ...
    "horarios_matricula": {
        "title": 'Horarios de matrícula',
        "category": "Catálogos",
        "description": 'Catálogo legacy de horarios usados por el proceso de matrícula.',
    ...
    "repositorio": {
        ...
        "detail_fields": fields(
            ...
            ("fechapublica", 'Fecha publicación', "date"),
            ("editorial", "Editorial"),
            ("url", "URL"),
            ("materia", "Materia"),
        ...
        "create_fields": fields(
            ...
            ("tipodocumento", "Tipo documento"),
            field("titulo", 'Título', required=True),
            ("autor", "Autor"),
            ("palabraclave", "Palabras clave", "textarea"),
            ("fechapublica", 'Fecha publicación', "date"),
            ("editorial", "Editorial"),
    ...
    "registro_documentos_estudiante": {
        ...
        "list_fields": fields(
            ("num", 'Código', "number"),
            ("IDESTUD", 'Código estudiante', "number"),
            ("estudiante_nombre", "Estudiante"),
            ("estudiante_cedula", 'Cédula'),
            ("DETALLE", "Detalle"),
            ("LINKURL", "Archivo"),
        ...
        "create_fields": fields(
            field("IDESTUD", 'Código estudiante', "number", required=True),
    ...
    "numero_preguntas": {
        ...
        "category": "Docencia",
        "description": 'Número de preguntas, intentos y tiempo de resolución por materia y período.',
    ...
    "planes_foros": {
        ...
        "category": "Docencia",
        "description": 'Menú legacy de cuestionarios, foros, fechas y recursos por materia.',
    ...
    "autoevaluacion_resultados": {
        "title": "Resultados de autoevaluación",
        "category": "Docencia",
        "description": 'Puntajes y comentarios de autoevaluación, coordinación y dirección.',
        ...
        "list_fields": fields(
            ...
            ("TipoPreg", "Tipo", "number"),
            ("Puntaje", "Puntaje", "number"),
            ("Calificacion", 'Calificación', "decimal"),
        ),
        "detail_fields": fields(
            ("Cod_Docente", "Docente", "number"),
            ("NoPregunta", "Pregunta", "number"),
    ...
    "certificados_generados": {
        ...
        "list_fields": fields(
            ("CertificadoId", 'Código', "number"),
            ("TipoCertificado", "Tipo"),
            ("NumeroCertificado", 'Número'),
            ("CedulaEst", 'Cédula'),
        ...
        "detail_fields": fields(
            ...
            ("TipoOrigen", "Origen"),
            ("NumeroCertificado", 'Número'),
            ("CodigoEstud", 'Código estudiante', "number"),
            ("CedulaEst", 'Cédula'),
            ("ApellidosNombre", "Estudiante"),
            ("Cod_AnioBasica", "Carrera", "number"),
            ("CodigoPeriodo", 'Período', "number"),
            ("CodigoMateria", "Materia", "number"),
            ("Num_Matricula", 'Matrícula', "number"),
            ("CodCurso", "Curso", "number"),
            ("FechaGeneracion", 'Fecha generación', "datetime"),
            ("UsuarioGenero", "Usuario"),
            ("RutaArchivo", "Archivo"),
            ("CodigoVerificacion", 'Código verificacion'),
            ("Estado", "Estado"),
    ...
    "corte_curso": {
        ...
        "key_fields": ["CorteId"],
        "list_fields": fields(
            ("CorteId", 'Código', "number"),
            ("TipoOferta", "Oferta"),
            ("NombreCorte", "Corte"),
            ("NumeroCorte", 'Número', "number"),
            ("FechaInicio", "Inicio", "date"),
            ("FechaFin", "Fin", "date"),
            ("EstadoCorte", "Estado"),
        ),
        ...
        "create_fields": fields(
            ...
            ("CodigoMateria", "Materia", "number"),
            ("CodCurso", "Curso", "number"),
            field("NumeroCorte", 'Número', "number", required=True),
    ...
    "corte_curso_estudiante": {
        ...
        "list_fields": fields(
            ("CorteEstudianteId", 'Código', "number"),
        ...
        "create_fields": fields(
            ...
            field("CodigoEstud", 'Código estudiante', "number", required=True),
            ("CedulaEst", 'Cédula'),
            ("ApellidosNombre", "Estudiante"),
            ("Cod_AnioBasica", "Carrera", "number"),
            ("CodigoPeriodo", 'Período', "number"),
    ...
    "talento_humano_empleados": {
        ...
        "description": 'Ficha base de empleados usada por el módulo RRHH de SisAcademicoV1.',
        "table": "[dbo].[TH_EMPLEADO]",
        "key_fields": ["empleado_id"],
        "list_fields": fields(
            ("empleado_id", 'Código', "number"),
    ...
    "talento_humano_solicitudes": {
        ...
        "detail_fields": fields(
            ...
            ("numero_dias_horas", 'Días/horas', "number"),
            ("documentos_respaldo", "Documentos", "textarea"),
            ("jefe_observaciones", "Observaciones jefe", "textarea"),
            ("th_validacion_nombre", "Validación de TH"),
            ("th_validacion_fecha", "Fecha de validación", "datetime"),
    ...
    "talento_humano_tareas": {
        ...
        "key_fields": ["tarea_id"],
        "list_fields": fields(
            ("tarea_id", 'Código', "number"),
            ("titulo", 'Título'),
            ("estado", "Estado"),
            ("prioridad", "Prioridad"),
            ("asignado_usuario_id", "Usuario asignado", "number"),
            ("fecha_limite", 'Límite', "date"),
            ("created_at", "Creado", "datetime"),
        ),
        "detail_fields": fields(
            ("tarea_id", 'Código', "number"),
            ...
            ("area_tipo_personal", 'Área/tipo personal'),
            ("estado", "Estado"),
            ("prioridad", "Prioridad"),
    ...
    "moodle_notas": {
        ...
        "detail_fields": fields(
            ...
            ("componente_nota", "Componente"),
            ("nota_obtenida", "Nota", "decimal"),
            ("nota_maxima", 'Nota máxima', "decimal"),
            ("porcentaje", "Porcentaje", "decimal"),
            ("estado", "Estado"),
            ("moodle_course_id", "Moodle course", "number"),
            ("moodle_grade_item_id", "Moodle item", "number"),
            ("fecha_calificacion", 'Fecha calificación', "datetime"),
            ("fecha_sincronizacion", 'Fecha sincronización', "datetime"),
            ("fecha_creacion", 'Fecha creación', "datetime"),
...
LOOKUP_QUERIES: dict[str, dict[str, list[str]]] = {
    ...
    "periodos": {
        ...
        "TipoMatricula": [
            ...
            UNION ALL
            SELECT N'E', N'E - Educación continua'
            """,
        ],
        "estado_ed": [
            """
...
def _section(key: str) -> dict[str, Any]:
    ...
    if not section:
        raise HTTPException(status_code=status.HTTP_404_NOT_FOUND, detail='Sección no disponible')
    return section
...
def _list_actualizacion_est_records(section: dict[str, Any], query: str | None, limit: int | None) -> dict[str, Any]:
    ...
    try:
        ...
        raise HTTPException(status_code=status.HTTP_500_INTERNAL_SERVER_ERROR, detail='No se pudo consultar la actualización de estados docentes') from exc
    return {
...
def _update_actualizacion_est_record(section: dict[str, Any], record_key: str, payload: SavePayload) -> dict[str, Any]:
    ...
    if not estado_codigo:
        raise HTTPException(status_code=status.HTTP_400_BAD_REQUEST, detail='Seleccione el estado del docente')
...
def _decode_key(record_key: str, expected_len: int) -> list[Any]:
    try:
        ...
        raise HTTPException(status_code=status.HTTP_400_BAD_REQUEST, detail='Clave de registro inválida') from exc
...
LEGACY_CLONE_MODULES: list[dict[str, Any]] = [
    {
        "key": "seguridad",
        "title": 'Seguridad, usuarios y menú',
    ...
    {
        "key": "estudiantes",
        "title": 'Estudiantes y ficha académica',
    ...
    {
        "key": "admision",
        "title": 'Admisión y preinscripción',
        "description": 'Aspirantes, asesores, datos de factura, documentos y paso a matrícula.',
        ...
        "coverage": "base",
        "notes": 'El flujo moderno de preinscripción reemplaza formularios duplicados de WebForms.',
    },
    {
        "key": "matricula",
        "title": 'Matrícula académica y financiera',
    ...
    },
    {
        ...
        "description": 'Ingreso de notas regulares, homologación, repetición, Moodle y fechas de apertura.',
        "source_paths": [
        ...
        "coverage": "partial",
        "notes": 'La lectura, los reportes y la administración base están cubiertos; falta cerrar el ingreso masivo de notas V1 como flujo dedicado.',
    },
    {
        "key": "docentes",
    ...
    },
    {
        ...
        "title": 'Evaluación docente y cuestionarios',
        "description": 'Evaluación estudiantil, autoevaluación, banco de preguntas, planes y foros.',
        ...
        "modern_routes": ["teacher_evaluation.py", "sisacademico_admin.py"],
        "coverage": "base",
        "notes": 'El motor moderno de evaluación debe prevalecer; las tablas V1 quedan como fuente histórica y administrable.',
    },
    {
        "key": "practicas",
        "title": 'Prácticas y vinculación con la sociedad',
        "description": 'Prácticas preprofesionales, vinculación con la sociedad, empresas y proyectos.',
        ...
        "coverage": "base",
        "notes": 'El módulo independiente puede reconocer datos legacy sin eliminarlos.',
    },
    {
        "key": "titulacion",
        "title": 'Titulación, complexivo y defensa',
    ...
    },
    {
        ...
        "tables": ["CERTIFICADOS_GENERADOS"],
        "modern_sections": ["certificados_generados"],
        "modern_routes": ["certificados.py", "legacy_reports.py", "sisacademico_admin.py"],
        "coverage": "base",
    ...
    },
    {
        ...
        "description": 'Cursos, cortes, estudiantes y certificados de educación continua.',
        ...
        "modern_sections": ["cursos_edu_continua", "corte_curso", "corte_curso_estudiante"],
        "modern_routes": ["sisacademico_admin.py"],
        "coverage": "base",
        "notes": 'Falta una vista dedicada si se requiere flujo completo de inscripción y certificación.',
    },
    {
        "key": "repositorio",
    ...
    },
    {
        ...
        "description": 'Notas Moodle, logs de sincronización y auditoría de Microsoft 365.',
        "source_paths": ["Intec/", "correo.aspx", "correo/", "CertificadoDigital/"],
        "tables": ["intec_estudiantenota", "intec_logmatriculacion", "intec_moodlegradesynclog", "Microsoft365Audit"],
        "modern_sections": ["moodle_notas", "moodle_sincronizacion", "microsoft365_audit"],
        "modern_routes": ["teams.py", "mass_email.py", "sisacademico_admin.py"],
        "coverage": "base",
    ...
    },
    {
        ...
        "coverage": "partial",
        "notes": 'Debe ejecutarse con auditoría, confirmación y permisos altos; no se replica el botón de eliminación de WebForms.',
    },
    {
        "key": "soporte_legacy_no_migrable",
        "title": "Soporte legacy no migrable",
        "description": 'Respaldos visuales, menus antiguos, archivos estaticos WebForms y visor Crystal que no son módulos operativos.',
        ...
        "modern_routes": [],
        "coverage": "excluded",
        "notes": "Se conserva como referencia histórica del proyecto, pero no se clona en el backend ni en el frontend moderno.",
    },
]
...
def legacy_v1_artifacts(_: SessionUser = AllowedEditor) -> dict[str, Any]:
    ...
    return {
        ...
        "strategy": "Clonación total navegable: cada artefacto heredado se clasifica como módulo moderno, mantenimiento controlado o soporte no migrable.",
        "totals": {
...
def _create_or_update_materia_homo_text(payload: SavePayload) -> dict[str, Any]:
    ...
    if not cod_materia:
        raise HTTPException(status_code=status.HTTP_400_BAD_REQUEST, detail='Campo requerido: Código materia')
    if cod_periodo is None:
        raise HTTPException(status_code=status.HTTP_400_BAD_REQUEST, detail='Campo requerido: Período')
    if not textofecha:
...
def _create_usuario_sis(payload: SavePayload) -> dict[str, Any]:
    ...
    if "cedula" in values:
        ...
        if len(str(values["cedula"])) > 10:
            raise HTTPException(status_code=status.HTTP_400_BAD_REQUEST, detail='Cédula no puede superar 10 caracteres')
    if "tp_us" in values:
...
def create_record(
    ...
    creatable = _field_map(section, "create_fields")
    if not creatable:
        raise HTTPException(status_code=status.HTTP_400_BAD_REQUEST, detail='Esta sección no permite creación directa')
    values: dict[str, Any] = {}
    for name, meta in creatable.items():
        value = payload.values.get(name)
        if meta.required and (value is None or value == ""):
