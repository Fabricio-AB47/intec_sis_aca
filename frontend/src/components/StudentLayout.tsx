  ...
  const adminMenuGroups: NavGroup[] = [
    ...
    },
    {
      ...
      items: [
        ...
        {
          label: 'Materias consecutivas',
          description: 'Continuidad y bloqueo por reprobación entre materias.',
          page: 'gestion-sisacademico',
          sectionKey: 'materias_consecutivas',
          action: () => onOpenGestionSisAcademico('materias_consecutivas'),
        },
        {
          label: 'Mallas',
        ...
        {
          label: 'Paralelos de horarios',
          description: 'Códigos de paralelo utilizados en la planificación de horarios.',
          page: 'gestion-sisacademico',
          sectionKey: 'paralelos_horarios',
          action: () => onOpenGestionSisAcademico('paralelos_horarios'),
        },
        {
          label: 'Días de la semana',
          description: 'Catálogo ordenado para la planificación académica.',
          page: 'gestion-sisacademico',
          sectionKey: 'dias_semana',
          action: () => onOpenGestionSisAcademico('dias_semana'),
        },
        ...
        {
          label: 'Horarios académicos',
          description: 'Materias, docentes, jornadas, paralelos y vigencia de clases.',
          page: 'gestion-sisacademico',
          sectionKey: 'horarios_academicos',
          action: () => onOpenGestionSisAcademico('horarios_academicos'),
        },
        {
          label: 'Apertura de autoevaluación',
