...
export const studentSubjects = [
  { subject: 'Programacion Avanzada', progress: 72 },
  { subject: 'Analitica de Datos', progress: 58 },
  { subject: 'Arquitectura de Software', progress: 81 },
  { subject: 'Gestion de Proyectos', progress: 64 },
]
