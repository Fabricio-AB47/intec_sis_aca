...
export function DashboardView({
  ...
  const activeRegularStudents = dashboardData?.active_regular_students
    ?? activeByType.find((item) => item.tipo_matricula === 'R')?.total_estudiantes
    ?? 0
  const activeHomologationStudents = dashboardData?.active_homologation_students
    ?? activeByType.find((item) => item.tipo_matricula === 'H')?.total_estudiantes
    ?? 0
  const activeRhStudents = dashboardData?.active_regular_homologation_students ?? activeRegularStudents + activeHomologationStudents
