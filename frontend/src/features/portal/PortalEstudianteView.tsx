  ...
  const practiceSubjectRows = useMemo(() => {
    const rows = academicRows
      .map((item) => {
        ...
        return {
          code,
          process: requirement?.label || (code === 'VIN' ? 'Servicio Comunitario' : 'Prácticas laborales'),
          level: 3,
    ...
    <div className="student-dashboard portal-page portal-student-page">
      ...
      {activeSection === 'academica' ? (
        <section className="student-card portal-record-card">
          ...
          <section className="portal-practice-requirements" aria-label="Cumplimiento de Prácticas laborales y Servicio Comunitario">
            <div className="portal-practice-requirements__head">
              ...
              <p>Requisitos independientes de la malla: 240 horas de Prácticas laborales y 60 horas de Servicio Comunitario.</p>
            </div>
            ...
            <div className="portal-practice-subjects">
              <div className="portal-practice-subjects__title">
                <strong>Asignaturas que aportan horas a Prácticas laborales y Servicio Comunitario</strong>
              </div>
